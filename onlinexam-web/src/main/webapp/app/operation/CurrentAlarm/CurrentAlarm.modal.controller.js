(function() {
    ...
    CurrentAlarmModalCtrl.$inject = ['$scope', '$uibModalInstance', '$http', '$filter', 'charts', 'CurrentAlarmService'];

    function CurrentAlarmModalCtrl($scope, $uibModalInstance, $http, $filter, charts, CurrentAlarmService) {
        var $ctrl = this;
        ...
        function initChart(limitLow, limitHigh) {
            CurrentAlarmService.query({ PiName: charts.name, Period: $ctrl.selected }, chartsSuccess);
