(function() {
    ...
    angular
        .module('webfullApp')
        .controller('DeviceDataModalCtrl', DeviceDataModalCtrl);

    DeviceDataModalCtrl.$inject = ['$scope', '$uibModalInstance', '$http', '$filter', 'charts', 'DeviceDataService'];

    function DeviceDataModalCtrl($scope, $uibModalInstance, $http, $filter, charts, DeviceDataService) {
        var $ctrl = this;
        ...
        function initChart(limitLow, limitHigh) {
            DeviceDataService.charts.query({ PiName: charts.name, Period: $ctrl.selected }, chartsSuccess);
