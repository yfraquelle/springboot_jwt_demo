(function() {
    ...
    Auth.$inject = ['$rootScope', '$state', '$q','Principal','AuthServerProvider'];
    ...
    function Auth ($rootScope, $state, $q, Principal,AuthServerProvider) {
        ...
        function authorize (force) {
            ...
            function authThen () {
                ...
                if (isAuthenticated  && ($rootScope.toState.name === 'login' || $rootScope.toState.name === 'register' || $rootScope.toState.name === 'social-auth')) {
                    $state.go('home');
                }
                if(!isAuthenticated){
                    $state.go('login');
